...
-- In Lean, "sorry" is used as a placeholder.
-- Try to complete these two on own. Please do not use rfl - these proofs are possible without it, and solving them manually shows understanding. You may find that the above lemmas are helpful!
